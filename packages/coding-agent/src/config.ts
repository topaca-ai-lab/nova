...
export function getUpdateInstruction(packageName: string): string {
	...
	switch (method) {
		case "bun-binary":
			return `Download from: https://github.com/topaca-ai-lab/nova/releases/latest`;
		case "pnpm":
...
export function getPackageDir(): string {
	...
	const envDir = process.env.NOVA_PACKAGE_DIR;
	if (envDir) {
...
export const APP_TITLE: string = "Nova";
export const CONFIG_DIR_NAME: string = pkg.novaConfig?.configDir || ".nova";
export const VERSION: string = pkg.version;

// e.g., NOVA_CODING_AGENT_DIR
export const ENV_AGENT_DIR = `${APP_NAME.toUpperCase()}_CODING_AGENT_DIR`;

const DEFAULT_SHARE_VIEWER_URL = "https://nova.topaca.com/session/";

/** Get the share viewer URL for a gist ID */
export function getShareViewerUrl(gistId: string): string {
	const baseUrl = process.env.NOVA_SHARE_VIEWER_URL || DEFAULT_SHARE_VIEWER_URL;

...
export interface ExtensionUIContext {
	 ...
	 * extend `CustomEditor` from `@nova-ai/nova-coding-agent` and call
	 * `super.handleInput(data)` for keys you don't handle.
	 *
	 * @example
	 * ```ts
	 * import { CustomEditor } from "@nova-ai/nova-coding-agent";
	 *
...
export interface ExtensionContext {
	...
	/** Gracefully shutdown nova and exit. Available in all contexts. */
	shutdown(): void;
...
export interface BeforeAgentStartEvent {
	...
	systemPrompt: string;
	/** Structured options used to build the system prompt. Extensions can inspect this to understand what Nova loaded without re-discovering resources. */
...
/** Configuration for registering a provider via nova.registerProvider(). */
...
export type ExtensionFactory = (nova: ExtensionAPI) => void | Promise<void>;
...
/**
 * Action implementations for nova.* API methods.

...
import { Container, Text, truncateToWidth } from "@nova-ai/nova-tui";
...
function getTempFilePath(): string {
	...
	return join(tmpdir(), `nova-bash-${id}.log`);
}
...
/**
 * Create bash operations using nova's built-in local shell execution backend.
 *
 * This is useful for extensions that intercept user_bash and still want nova's

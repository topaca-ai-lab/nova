    (function() {
      ...
      const injectedParams = document.querySelector('meta[name="nova-url-params"]');
      ...
      function buildShareUrl(entryId) {
        ...
        const baseUrlMeta = document.querySelector('meta[name="nova-share-base-url"]');
      ...
      const SIDEBAR_WIDTH_STORAGE_KEY = 'nova-share:v1:sidebar-width';

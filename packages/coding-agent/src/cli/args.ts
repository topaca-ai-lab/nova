...
${chalk.bold("Commands:")}
  ...
  ${APP_NAME} local bench diff ...      Compare two stored benchmark artifacts
...
${chalk.bold("Environment Variables:")}
  ...
  NOVA_SHARE_VIEWER_URL              - Base URL for /share command (default: https://nova.topaca.com/session/)
  NOVA_LOCAL_BASE_URL                - Default base URL for 'nova local doctor'
  NOVA_LOCAL_MODEL                   - Default model for 'nova local doctor' (default: qwen3.6)
  NOVA_LOCAL_BACKEND                 - Backend hint for 'nova local doctor' (default: LiteLLM+Ollama)
  ...
  NOVA_LOCAL_PROVIDER                - Target provider name for local profile overlay (default: openai)
  NOVA_AI_ANTIGRAVITY_VERSION        - Override Antigravity User-Agent version (e.g., 1.23.0)

...
const CALLBACK_HOST = process.env.NOVA_OAUTH_CALLBACK_HOST || "127.0.0.1";
...
const CLIENT_ID = process.env.NOVA_GOOGLE_ANTIGRAVITY_OAUTH_CLIENT_ID || "";
const CLIENT_SECRET = process.env.NOVA_GOOGLE_ANTIGRAVITY_OAUTH_CLIENT_SECRET || "";
